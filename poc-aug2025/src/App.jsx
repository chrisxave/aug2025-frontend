...
function App() {
  ...
  console.log("API URL:", API_URL); // Cek apakah API_URL kebaca
  ...
  const fetchProducts = async () => {
    try {
      ...
      console.log("Fetched products:", data); // Log isi data
      setProducts(data);
    } catch (error) {
  ...
  const addProduct = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        alert(`Failed to add product: ${result?.detail || "Unknown error"}`);
        return;
      }
